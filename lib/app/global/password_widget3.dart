...
import 'package:teste_fasitec/app/global/address_widget3.dart';
import 'package:teste_fasitec/app/modules/form3/form3_controller.dart';

class PasswordWidget3 extends StatelessWidget {
  final Form3Controller controller;
  const PasswordWidget3({super.key, required this.controller});
                          ...
                          child: ListView(
                            ...
                            children: [
                              SizedBox(
                                ...
                                width: Get.width,
                                child: AddressWidget3(controller: controller),
                              )
                            ],
                          ),
                        ),
